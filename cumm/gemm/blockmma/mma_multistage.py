...
class AsyncCopyIteration(pccm.ParameterizedClass):
    def __init__(self, InputIter: MaskTileIterator, SmemIter: SmemTileIterator, num_warp_mma_iters, nIdx=0) -> None:
        ...
        self.input_args = list(InputIter.enumurate_get_param())
        self.smem_args = list(SmemIter.enumurate_get_param())
...
class MmaMultiStage(pccm.ParameterizedClass):
    ...
    def __init__(self,
        ...
        super().__init__()
        assert smem_clear_opt == SharedMemoryClearOption.kNone, "Not Implemented"
